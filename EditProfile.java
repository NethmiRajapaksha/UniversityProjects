...
public class EditProfile extends AppCompatActivity {
    ...
    private void storeImage(){
        if (!uploadName.getText().toString().isEmpty() && !uploadEmail.getText().toString().isEmpty() && !uploadNumber.getText().toString().isEmpty() && uploadImage.getDrawable() != null && bitmapImage != null){
            databaseHelper.storeData(new ModelClass(uploadName.getText().toString(), uploadEmail.getText().toString(), uploadNumber.getText().toString(), bitmapImage));
